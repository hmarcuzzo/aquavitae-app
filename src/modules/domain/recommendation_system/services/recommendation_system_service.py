...
class RecommendationSystemService:
    ...
    async def complete_nutritional_plan(
        ...
        user_food_preference = await self.user_food_preferences(
    ...
    def __define_score_by_preference_type(
        ...
        for food_to_grade in foods_to_grade:
            ...
            RecommendationSystemService.__award_score(foods_dt, food_to_grade.id, score)
    ...
    def __award_score_by_consumption(
        ...
        for food_id in fatigued_food:
            RecommendationSystemService.__award_score(foods_dt, food_id, -100)
        ...
        for food_id, food_amount in user_consumption:
            ...
            RecommendationSystemService.__award_score(foods_dt, food_id, score)
