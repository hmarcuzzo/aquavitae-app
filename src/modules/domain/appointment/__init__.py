...
from .entities.appointment_has_appointment_goal_entity import AppointmentHasAppointmentGoal
...
appointment_entities = [Appointment, AppointmentGoal, AppointmentHasAppointmentGoal]
